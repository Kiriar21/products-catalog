...
internal class PublishNewVersionProductByTrackingHandler : ICommandHandler<PublishNewVersionProductByTracking>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly IProductsRepository _repository;

    public PublishNewVersionProductByTrackingHandler(IProductsRepository repository, IUnitOfWork unitOfWork)
    {
        _repository = repository;
        _unitOfWork = unitOfWork;
    }

    public async Task<Result> Handle(PublishNewVersionProductByTracking command, CancellationToken ct = default)
    {
