...
public class ValidationEmptyCommandDecorator<TCommand> : ICommandHandler<TCommand>
{
    private readonly ICommandHandler<TCommand> _handler;
    private readonly ILogger<ValidationEmptyCommandDecorator<TCommand>> _logger;
    private readonly IEnumerable<IValidator<TCommand>>_validators;
    private readonly IUserContext _userContext;
    

    public ValidationEmptyCommandDecorator(ICommandHandler<TCommand> handler, ILogger<ValidationEmptyCommandDecorator<TCommand>> logger, IEnumerable<IValidator<TCommand>> validators, IUserContext userContext)
    {
        _handler = handler;
        _logger = logger;
