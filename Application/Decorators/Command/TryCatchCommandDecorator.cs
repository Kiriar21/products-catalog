...
public sealed class TryCatchCommandDecorator<TCommand, TResponse> : ICommandHandler<TCommand, TResponse> where TCommand: ICommand<TResponse>
{
    private readonly ICommandHandler<TCommand, TResponse> _handler;
    private readonly ILogger<TryCatchCommandDecorator<TCommand, TResponse>> _logger;
    private readonly IUserContext _userContext;
    public TryCatchCommandDecorator(ICommandHandler<TCommand, TResponse> handler, ILogger<TryCatchCommandDecorator<TCommand, TResponse>> logger,  IUserContext userContext)
    {
        _handler = handler;
        _logger = logger;
